...
public class TestVMProcess {
    ...
    private static String[] getDefaultFlags() {
        return new String[] {"-XX:-BackgroundCompilation", "-XX:CompileCommand=quiet", "-XX:CompileCommand=PrintCompilation,compiler.valhalla.inlinetypes.TestLWorld::test178"};
    }
